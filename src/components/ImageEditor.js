        ...
        <div>
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="d-flex justify-content-center">
              <p className="col-6 text-justify text-wrap break-word description">
                Suspendisse diam tristique rhoncus mauris ut enim risus. Ipsum
                varius eget fermentum eget nam gravida nulla. Lacus convallis
                purus iaculis in magna non cras nisl eu. Dignissim volutpat
                aliquam nulla cras arcu lobortis facilisi egestas.{" "}
              </p>
            </div>
        ...
        <div>
          ...
          <div className="col-12 pe-5">
            <div className="d-flex justify-content-between pe-5">
              <div className="logoText">Online Photo Editor</div>
